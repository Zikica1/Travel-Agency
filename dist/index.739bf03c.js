...
async function load() {
    const page = await require("c139990866c2283");
    page.render();
}
load();
//Observer
...
},{"c139990866c2283":"kePhp"}],"kePhp":[function(require,module,exports) {
module.exports = require("f6f8b13de5aaad5")(require("4d97bc22d55743c0").getBundleURL("g05j8") + "global.6c9f5b79.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("ivXNZ"));

},{"f6f8b13de5aaad5":"61B45","4d97bc22d55743c0":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
...
},{}]},["gHDMI","ebWYT"], "ebWYT", "parcelRequire56b7")
